...
public class InterfaceUtilisateur {
    ...
    public InterfaceUtilisateur() { // on ne s'ent sert pas, sauf dans le main du projet
    ...
    public ScanNomMode monTest1QuiEstMaMethodeMain() throws Exception {
        try {
            ...
            InterfaceUtilisateur inter = new InterfaceUtilisateur(new Patronne("initValue"));
            ...
            //  InterfaceUtilisateur.firstScanner();
            Manipuler Bar = null;
